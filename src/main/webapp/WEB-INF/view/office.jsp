...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/resources/resview/pdfjs-1.1.114-dist/web/viewer.css">
    <link rel="resource" type="application/l10n"
          href="${ctx}/resources/resview/pdfjs-1.1.114-dist/web/locale/locale.properties"/>
</head>
...
<!-- outerContainer -->
<div id="printContainer" style="clear: both"></div>
...
<div id="siteMeshJavaScript">
    ...
    <script src="${ctx}/resources/resview/pdfjs-1.1.114-dist/web/compatibility.js"></script>
    <script src="${ctx}/resources/resview/pdfjs-1.1.114-dist/build/pdf.js"></script>
    <script src="${ctx}/resources/resview/pdfjs-1.1.114-dist/web/l10n.js"></script>
    <script src="${ctx}/resources/resview/pdfjs-1.1.114-dist/web/debugger.js"></script>
    <script src="${ctx}/resources/resview/pdfjs-1.1.114-dist/web/viewer.js"></script>
    <script type="text/javascript">
        var DEFAULT_URL = '${ctx}/sdo/getPDF?targetFilePath=${targetFilePath}';
        PDFJS.imageResourcesPath = '${ctx}/resources/resview/pdfjs-1.1.114-dist/web/images/';
        PDFJS.workerSrc = '${ctx}/resources/resview/pdfjs-1.1.114-dist/build/pdf.worker.js';
        PDFJS.cMapUrl = '${ctx}/resources/resview/pdfjs-1.1.114-dist/web/cmaps/';
       /* PDFJS.viewerWrapper = parent.document.getElementById("viewerWrapper");
        var pdfFileName = '${resname}';
