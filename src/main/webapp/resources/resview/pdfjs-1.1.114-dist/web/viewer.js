...
var PDFPresentationMode = (function PDFPresentationModeClosure() {
    ...
    PDFPresentationMode.prototype = {
        ...
        request: function PDFPresentationMode_request() {
            ...
            if (pmBtn.className == "toolbarButton presentationMode hiddenLargeView") {
                vw.style.width = (ww - 5) + "px";
                vw.style.height = (wh - 5) + "px";
                vw.style.position = "fixed";
                vw.style.top = 0;
                vw.style.left = 0;
                pmBtn.className = "toolbarButton presentationModeOff hiddenLargeView";
            } else {
                vw.style.position = "static";
                vw.style.width = WRAPPER_WIDTH;
                vw.style.height = WRAPPER_HEIGHT;
                pmBtn.className = "toolbarButton presentationMode hiddenLargeView";
            }
    ...
    PDFViewer.prototype = /** @lends PDFViewer.prototype */{
        ...
        _setScaleUpdatePages: function pdfViewer_setScaleUpdatePages(newScale, newValue, noScroll, preset) {
            ...
            if (!noScroll) {
                ...
                if (this.location && !IGNORE_CURRENT_POSITION_ON_ZOOM && !(this.isInPresentationMode || this.isChangingPresentationMode)) {
...
window.addEventListener('change', function webViewerChange(evt) {
    ...
    // PDFViewerApplication.setTitleUsingUrl(file.name); html title 注释掉
...
window.addEventListener('keydown', function keydown(evt) {
    ...
    if (!handled && !isViewerInPresentationMode) {
        ...
        if (evt.keyCode >= 33 && evt.keyCode <= 40 && !pdfViewer.containsElement(curElement)) {
        ...
        // 32=Spacebar
        if (evt.keyCode === 32 && curElementTagName !== 'BUTTON' && !pdfViewer.containsElement(curElement)) {
            pdfViewer.focus();
        }
    }
