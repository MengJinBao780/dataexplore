...
/**
 * Created by xiajl on 2016/4/25.
 */
public class CasURLCode {
     ...
     */
    //static public byte[] decode(final String chars) throws InvalidBase32 {
    static public String decode(final String chars) throws InvalidBase32 {
    ...
    static private int locate(final char c) throws InvalidBase32 {
        return 'a' <= c && 'z' >= c ? c - 'a'
                : '2' <= c && '7' >= c
                ? 26 + (c - '2')
                : 'A' <= c && 'Z' >= c
    ...
    static private int invalid() throws InvalidBase32 {
        throw new InvalidBase32();
    }
}


class InvalidBase32 extends RuntimeException {
    static private final long serialVersionUID = 1L;

    /**
     * Constructs an instance.
     */
    public InvalidBase32() {}
}
