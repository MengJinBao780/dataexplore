...
public class CSTRDebugNew  implements Runnable {
    public static void main(String[] args) {
        CSTRDebugNew cstrTest = new CSTRDebugNew();
    ...
    public void run() {
        try {
            ...
            URL url = new URL("http://14.23.68.86:9002/resolution/CSTR:00000.11.01.rINuDqM1Hr");
