...
public class CSTRTestNew implements Runnable {
    public static void main(String[] args) {
        CSTRTestNew cstrTest = new CSTRTestNew();
...
//	             DataOutputStream dataOutputStream = new DataOutputStream(outputStream);
                ...
                //xiajl20180828修改
                String passwordStr = AESEncryptUtil.AESEncode("CNIC@niot1234","bigdata");
                passwordStr= URLEncoder.encode(passwordStr, "UTF-8");
                String content = "username=bigdata&password=" + passwordStr +"&content="+message;
